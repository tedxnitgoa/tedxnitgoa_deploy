            ...
            <div className="footerStyles_footer_main__QPqPA">
              <div>
                ...
                <div className="footerStyles_footer_social__ncNPp">
                  ...
                  <a href="https://www.linkedin.com/company/tedx-iit-guwahati/" target="_blank" rel="noopener noreferrer" className="footerStyles_social_icon__BHDZ9">
                    <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 448 512" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                      <path d="M100.28 448H7.4V148.9h92.88zM53.79 108.1C24.09 108.1 0 83.5 0 53.8a53.79 53.79 0 0 1 107.58 0c0 29.7-24.1 54.3-53.79 54.3zM447.9 448h-92.68V302.4c0-34.7-.7-79.2-48.29-79.2-48.29 0-55.69 37.7-55.69 76.7V448h-92.78V148.9h89.08v40.8h1.3c12.4-23.5 42.69-48.3 87.88-48.3 94 0 111.28 61.9 111.28 142.3V448z"></path>
                    </svg>
                  </a>
                  <a href="https://x.com/tedxiitg?t=pHLpmiyIYiubcmoUCuQrPA&amp;s=08" target="_blank" rel="noopener noreferrer" className="footerStyles_social_icon__BHDZ9">
                    <svg stroke="currentColor" fill="currentColor" strokeWidth="  0" viewBox="0 0 512 512" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                      <path d="M389.2 48h70.6L305.6 224.2 487 464H345L233.7 318.6 106.5 464H35.8L200.7 275.5 26.8 48H172.4L272.9 180.9 389.2 48zM364.4 421.8h39.1L151.1 88h-42L364.4 421.8z"></path>
                    </svg>
                  </a>
                  <a href="https://www.facebook.com/TEDxIITGuwahati?mibextid=ZbWKwL" target="_blank" rel="noopener noreferrer" className="footerStyles_social_icon__BHDZ9">
                    <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 320 512" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                      <path d="M279.14 288l14.22-92.66h-88.91v-60.13c0-25.35 12.42-50.06 52.24-50.06h40.42V6.26S260.43 0 225.36 0c-73.22 0-121.08 44.38-121.08 124.72v70.62H22.89V288h81.39v224h100.17V288z"></path>
                    </svg>
                  </a>
                  <a href="https://tedxiitguwahati.medium.com/" target="_blank" rel="noopener noreferrer" className="footerStyles_social_icon__BHDZ9">
                    <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 448 512" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <a href="https://www.threads.net/@tedxiitguwahati" target="_blank" rel="noopener noreferrer" className="footerStyles_social_icon__BHDZ9">
                    <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 448 512" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <div className="footerStyles_email__yM-+x">
                    <p>Mail us at <a className="footerStyles_gmail__fYYwp" href="">nitg.tedx@gmail.com</a></p>
                  </div>
                </div>
              </div>
              ...
              <div className="footerStyles_footer_col_2__2aZ3f">
                ...
                <div className="footer-links">
                  ...
                  <a title="About Us" className="footerStyles_links_col_2__Qv075" href="/AboutUs">About Us</a>
                  ...
                  <a title="Teams" className="footerStyles_links_col_2__Qv075" href="/">Teams</a>
